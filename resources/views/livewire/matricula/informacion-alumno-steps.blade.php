<div>
    ...
    <div class="tabs-nueva-matricula " style="min-height: 85vh">
        <ul class="nav nav-tabs">
            ...
            <li class=" "><a data-toggle="tab" href="#tab-3">HISTORIAL MATRICULAS</a></li>
            <li class=" "><a data-toggle="tab" href="#tab-4">MATRICULA</a></li>
            <li class=" "><a data-toggle="tab" href="#tab-5">PAGOS</a></li>
        </ul>
            ...
            <div id="tab-3" class="tab-pane">
                <div class="panel-body ">
                    <!-- Begin: contenido matricula -->
                        @livewire('matricula.partials.lista-matriculas')
