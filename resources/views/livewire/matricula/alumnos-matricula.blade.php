<div>
            ...
            <div class="ibox">
                ...
                <div class="ibox-content">
                    <div class="input-group col-md-8" style=" margin: auto; margin-bottom: 3rem;">
                        <input type="text" class="form-control" placeholder="Ingrese DNI, apellidos o nombres del alumno" wire:model="search"> 
    ...
    <!-- Modal alumno -->
    <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" wire:ignore.self aria-hidden="true">
