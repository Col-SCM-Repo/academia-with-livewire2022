...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('chameleon/vendors/css/tables/datatable/datatables.min.css') }}">
    <!-- END: Vendor CSS-->

    <!-- BEGIN: Theme CSS-->
    <link rel="stylesheet" type="text/css" href="{{ asset('chameleon/css/bootstrap.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('chameleon/css/bootstrap-extended.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('chameleon/css/colors.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('chameleon/css/components.min.css') }}">
    <!-- END: Theme CSS-->
  ...
  <!-- BEGIN: Body-->
  <body class="horizontal-layout horizontal-menu 2-columns menu-expanded pace-done" data-open="hover" data-menu="horizontal-menu" data-color="bg-gradient-x-purple-blue" data-col="2-columns">

    <!-- BEGIN: Header-->
    <nav style="height: 10%" class="header-navbar navbar-expand-md navbar navbar-with-menu navbar-without-dd-arrow navbar-static-top navbar-light navbar-brand-center">
      <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
          <li class="nav-item mobile-menu d-md-none mr-auto"><a class="nav-link nav-menu-main menu-toggle hidden-xs" href="#"><i class="ft-menu font-large-1"></i></a></li>
          <li class="nav-item"><a class="navbar-brand" href="javascript:void(0);">
              <img class="brand-logo" alt="creaative admin logo" src="{{asset('chameleon/images/logo/logo.png')}}">
              <h3 class="brand-text" style="font-size: 1.3rem;">TEST DESCUBRE</h3></a>
          </li>
    ...
    <div class="header-navbar navbar-expand-sm navbar navbar-horizontal navbar-fixed navbar-dark navbar-without-dd-arrow navbar-shadow navbar-brand-center" role="navigation" data-menu="menu-wrapper">
      <div class="navbar-container main-menu-content" data-menu="menu-container">
        <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
          <li id="home" class="nav-item"><a class="nav-link" href="#"><i class="ft-home"></i><span>Inicio</span></a></li>

          <li id="applicants" class="nav-item"><a class="nav-link" href="#"><i class="fas fa-user-graduate font-medium-3"></i><span>Alumnos evaluados</span></a></li>

          <li id="reporting" class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="" data-toggle="dropdown"><i class="fas fa-file-contract font-medium-3"></i><span>Reportes</span></a>
            <ul class="dropdown-menu">
                <div class="arrow_box">
                  <li id="reporting-1" data-menu=""><a class="dropdown-item" href="#" data-toggle="dropdown">Resumen de alumnos y evaluaciones.</a>
                    </li>
          ...
          <li id="settings" class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><i class="ft-settings"></i><span>Configuraciones</span></a>
            <ul class="dropdown-menu">
                <div class="arrow_box">
                    <li id="settings-personalities" data-menu=""><a class="dropdown-item" href="#" data-toggle="dropdown"><i class="fas fa-theater-masks font-medium-3"></i> Personalidades</a>
                    </li>

                    <li id="settings-items" data-menu=""><a class="dropdown-item" href="#" data-toggle="dropdown"><i class="far fa-question-circle font-medium-3"></i> Items de evaluación</a>
                    </li>

                    <li id="settings-careers" data-menu=""><a class="dropdown-item" href="#" data-toggle="dropdown"><i class="fas fa-graduation-cap font-medium-3"></i> Carreras profesionales</a>
                    </li>

                    <li id="settings-users" data-menu=""><a class="dropdown-item" href="#" data-toggle="dropdown"><i class="fas fa-user-shield font-medium-3"></i> Usuarios</a>
                    </li>
                </div>
            </ul>
          </li>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        <p class="card-text">DataTables allows ordering by multiple columns at the same time, which can be activated in a number of different ways</p>
                        <div class="table-responsive">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        <p class="card-text">When using tables to display data, you will often wish to display column information in groups. DataTables fully supports colspan and rowspan in the table's header, assigning the required order listeners to the TH element suitable for that column.</p>
                        <div class="table-responsive">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        <p class="card-text">This example shows a vertically scrolling DataTable that makes use of the CSS3 (vh) unit in order to dynamically resize the viewport based on the browser window height. The (vh) unit is effectively a percentage of the browser window height. So the (50vh) used in this example is 50% of the window height. The viewport size will update dynamically as the window is resized.</p>
                        <div class="table-responsive">
...
<!--/ Language - Comma decimal place table -->
    ...
    <script src="{{ asset('chameleon/vendors/js/tables/datatable/datatables.min.js') }}" type="text/javascript"></script>
    <!-- END: Page Vendor JS-->
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{ asset('chameleon/js/scripts/tables/datatables/datatable-basic.min.js') }}" type="text/javascript"></script>
    <!-- END: Page JS-->
